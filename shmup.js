...
function update() {
  ...
  for (var b = 0; b < enemies.children.length; b++) {
    ...
    for (var c = 0; c < bullets.children.length; c++) {
      if (
        bullets.children[c].x >= enemies.children[b].x &&
        bullets.children[c].x + 11 < enemies.children[b].x + 49 &&
        bullets.children[c].y < enemies.children[b].y + 40
      ) {
      ...
      if (
        boss != null &&
        bullets.children[c].x >= boss.x &&
        bullets.children[c].x + 11 < boss.x + 183 &&
        bullets.children[c].y < boss.y + 162
      ) {
        bullets.removeChildAt(c);
        bossHealth--;
        stage.update();
...
function addGameView() {
  ...
  Tween.get(ship).to({ y: 425 }, 1e3).call(startGame);
}
function loadGfx(a) {
  if ((a.target.name = "bg")) {
    bg = new Bitmap(bgImg);
...
(function (a) {
  ...
  Ticker._tick = function () {
    ...
    Ticker._lastTime = a;
    for (
      var d = Ticker._pauseable,
        e = Ticker._listeners.slice(),
        f = e ? e.length : 0,
        g = 0;
      g < f;
      g++
...
(function (a) {
  ...
  b.prependTransform = function (a, b, c, d, e, f, g, h, i) {
    ...
    } else this.prepend(e * c, j * c, -j * d, e * d, a, b);
  };
  b.appendTransform = function (a, b, c, d, e, f, g, h, i) {
    ...
    } else this.append(e * c, j * c, -j * d, e * d, a, b);
    if (h || i) {
...
(function (l) {
  ...
  a.quadraticCurveTo = function (a, c, d, e) {
    ...
    this._activeInstructions.push(
      new b(this._ctx.quadraticCurveTo, [a, c, d, e])
    );
    return this;
  };
  a.bezierCurveTo = function (a, c, d, e, f, g) {
    this._dirty = this._active = true;
    this._activeInstructions.push(
      new b(this._ctx.bezierCurveTo, [a, c, d, e, f, g])
    );
    this._boundsQueue.push(
      new b(this._bezierCurveToBounds, [_x, _y, a, c, d, e, f, g])
    );
    return this;
  };
  ...
  a.beginFill = function (a) {
    ...
    this._fillInstructions = a
      ? [new b(this._setProp, ["fillStyle", a])]
      : null;
    return this;
  };
  a.beginLinearGradientFill = function (a, c, d, e, f, g) {
    ...
    e = 0;
    for (f = a.length; e < f; e++) d.addColorStop(c[e], a[e]);
  ...
  a.setStrokeStyle = function (a, c, d, e) {
    this._active && this._newPath();
    this._strokeStyleInstructions = [
      new b(this._setProp, ["lineWidth", a == null ? "1" : a]),
      new b(this._setProp, [
        "lineCap",
        c == null ? "butt" : isNaN(c) ? c : Graphics.STROKE_CAPS_MAP[c],
      ]),
      new b(this._setProp, [
        "lineJoin",
        d == null ? "miter" : isNaN(d) ? d : Graphics.STROKE_JOINTS_MAP[d],
      ]),
      new b(this._setProp, ["miterLimit", e == null ? "10" : e]),
    ];
    return this;
  };
  a.beginStroke = function (a) {
    ...
    this._strokeInstructions = a
      ? [new b(this._setProp, ["strokeStyle", a])]
      : null;
    return this;
  };
  ...
  a.drawRoundRectComplex = function (a, c, d, e, f, g, h, i) {
    this._dirty = this._active = true;
    this._activeInstructions.push(
      new b(this._ctx.moveTo, [a + f, c]),
      new b(this._ctx.lineTo, [a + d - g, c]),
      new b(this._ctx.arc, [a + d - g, c + g, g, -Math.PI / 2, 0, false]),
      new b(this._ctx.lineTo, [a + d, c + e - h]),
      new b(this._ctx.arc, [a + d - h, c + e - h, h, 0, Math.PI / 2, false]),
      new b(this._ctx.lineTo, [a + i, c + e]),
      new b(this._ctx.arc, [a + i, c + e - i, i, Math.PI / 2, Math.PI, false]),
      new b(this._ctx.lineTo, [a, c + f]),
      new b(this._ctx.arc, [a + f, c + f, f, Math.PI, (Math.PI * 3) / 2, false])
    );
    return this;
  };
  ...
  a.drawEllipse = function (a, c, d, e) {
    ...
    e = c + e / 2;
    this._activeInstructions.push(
      new b(this._ctx.moveTo, [a, e]),
      new b(this._ctx.bezierCurveTo, [a, e - g, d - f, c, d, c]),
      new b(this._ctx.bezierCurveTo, [d + f, c, h, e - g, h, e]),
      new b(this._ctx.bezierCurveTo, [h, e + g, d + f, i, d, i]),
      new b(this._ctx.bezierCurveTo, [d - f, i, a, e + g, a, e])
    );
    return this;
  };
  a.drawPolyStar = function (a, c, d, e, f, g) {
    ...
    var h = Math.PI / e;
    this._activeInstructions.push(
      new b(this._ctx.moveTo, [a + Math.cos(g) * d, c + Math.sin(g) * d])
    );
    for (var i = 0; i < e; i++) {
      g += h;
      f != 1 &&
        this._activeInstructions.push(
          new b(this._ctx.lineTo, [
            a + Math.cos(g) * d * f,
            c + Math.sin(g) * d * f,
          ])
        );
      g += h;
      this._activeInstructions.push(
        new b(this._ctx.lineTo, [a + Math.cos(g) * d, c + Math.sin(g) * d])
      );
    }
    return this;
  };
  ...
  a._extendBounds = function (a, b) {
    if (isNaN(this._minX)) {
      ...
      if (a < this._minX) this._minX = a;
      else if (a > this._maxX) this._maxX = a;
      if (b < this._minY) this._minY = b;
      else if (b > this._maxY) this._maxY = b;
    }
  };
  a._updateBounds = function () {
    for (; boundsQueue.length; ) boundsQueue.pop().exec(this);
  };
  ...
  b.updateCache = function (a) {
    ...
    if (a) b.globalCompositeOperation = a;
      ...
      b.clearRect(
        0,
        0,
        this.cacheCanvas.width + 1,
        this.cacheCanvas.height + 1
      );
    this.draw(b, true);
...
(function (a) {
    ...
    for (var e = this.children.slice(0), f = 0; f < b; f++) {
      ...
      if (g.isVisible()) {
        ...
        if (!(g instanceof Container && g.cacheCanvas == null)) {
          d && g.snapToPixel && i.a == 1 && i.b == 0 && i.c == 0 && i.d == 1
            ? a.setTransform(
                i.a,
                i.b,
                i.c,
          ...
          if ((h = i.shadow)) this.applyShadow(a, h);
        }
        g.draw(a, false, i);
  ...
  b.addChildAt = function (a, b) {
    ...
    if (c > 2) {
      b = arguments[d - 1];
      for (var d = 0; d < c - 1; d++) this.addChildAt(arguments[d], b + d);
  ...
  b.removeChildAt = function (a) {
    ...
    if (b > 1) {
      ...
      var e = true;
      for (d = 0; d < b; d++) e = e && this.removeChildAt(c[d]);
      return e;
    }
  ...
  b.clone = function (a) {
    ...
    if (a)
      for (
        var c = (b.children = []), d = 0, e = this.children.length;
        d < e;
        d++
      )
  ...
  b._getObjectsUnderPoint = function (a, b, c, d) {
    var e = DisplayObject._hitTestContext,
      ...
      h =
        (d & 1 && (this.onPress || this.onClick || this.onDoubleClick)) ||
        (d & 2 && (this.onMouseOver || this.onMouseOut));
    if (this.cacheCanvas) {
    ...
    for (var i = this.children.length - 1; i >= 0; i--) {
      ...
      if (j.isVisible() && j.mouseEnabled)
        if (j instanceof Container)
          ...
          !d ||
          h ||
          (d & 1 && (j.onPress || j.onClick || j.onDoubleClick)) ||
          (d & 2 && (j.onMouseOver || j.onMouseOut))
        ) {
...
(function (a) {
  ...
  b.update = function () {
    if (this.canvas) {
      ...
      this.draw(
        ...
        false,
        this.getConcatenatedMatrix(DisplayObject._workingMatrix)
      );
    }
  };
  b.tick = b.update;
  ...
  b._handleMouseMove = function (b) {
    if (this.canvas) {
      ...
      if (c || this.mouseInBounds) {
        ...
        c.nativeEvent = b;
        if (this.onMouseMove) this.onMouseMove(c);
  ...
  b._updateMousePosition = function (a, b) {
    ...
    if (
      (this.mouseInBounds =
        a >= 0 && b >= 0 && a < this.canvas.width && b < this.canvas.height)
    ) {
      this.mouseX = a;
      this.mouseY = b;
    }
  ...
  b._handleMouseDown = function (a) {
    ...
    var c = this._getObjectsUnderPoint(
      this.mouseX,
      this.mouseY,
      null,
      this._mouseOverIntervalID ? 3 : 1
    ...
    if (
      ...
      if (this._mouseOverTarget != a) {
        if (this._mouseOverTarget && this._mouseOverTarget.onMouseOut)
          this._mouseOverTarget.onMouseOut(
            new MouseEvent("onMouseOver", this.mouseX, this.mouseY)
          );
        if (a && a.onMouseOver)
...
(function (a) {
  ...
  b.isVisible = function () {
    return (
      ...
      this.scaleY != 0 &&
      this.image &&
      (this.image.complete || this.image.getContext)
    );
  };
  b.DisplayObject_draw = b.draw;
  b.draw = function (a, b) {
  ...
  b._calculateBounds = function () {
    return this.image && (this.image.complete || this.image.getContext)
...
(function (a) {
  ...
  b.draw = function (a, b) {
    ...
    this.currentFrame >= 0 &&
      a.drawImage(
        c,
        d * (this.currentFrame % f),
        e * ((this.currentFrame / f) | 0),
        d,
        e,
        0,
        0,
...
(function (a) {
  ...
  b._drawTextLine = function (a, b, c) {
    this.outline
      ? a.strokeText(b, 0, c, this.maxWidth)
      : a.fillText(b, 0, c, this.maxWidth);
  };
  b._calculateBounds = function () {};
  a.Text = Text;
})(window);
(function (a) {
  ...
  SpriteSheetUtils._workingContext =
    SpriteSheetUtils._workingCanvas.getContext("2d");
  SpriteSheetUtils.flip = function (a, b) {
    ...
    for (o = 0; o < m.length; o += 4) {
      ...
      i = k[1] ? -1 : 1;
      for (
        var r = k[2] ? -1 : 1, s = i == -1 ? e : 0, t = r == -1 ? f : 0, u = p;
        u <= q;
        u++
      ) {
        h++;
...
(function (a) {
  ...
  b.wait = function (a) {
    ...
    return this._addStep({ d: a, p0: b, e: this._linearEase, p1: b });
  };
  b.to = function (a, b, c) {
    if (isNaN(b) || b < 0) {
      b = 0;
...
(function (a) {
  ...
  b.add = function (a, c, d) {
    b.loadQueue.push({ name: a, src: c, instances: d });
    b.loadQueue.length == 1
      ? ((b.itemsToLoad = 1), b.loadNext())
      : b.itemsToLoad++;
  };
  b.addBatch = function (a) {
    for (var c = a.length; a.length; ) b.loadQueue.push(a.shift());
    b.loadQueue.length == c
      ? (b.loadNext(), (b.itemsToLoad = c))
      : b.itemsToLoad++;
  };
  b.play = function (a, c, d, e, f) {
    ...
    else return b.beginPlaying(a, c, d, e);
    return -1;
  };
    ...
    if (Number(a) != null) {
      ...
      if (b._master != c)
        for (e in b.soundHash) {
          d = b.soundHash[e];
          c = d.length;
          for (a = 0; a < c; a++) d[a].volume = d[a].storedVolume * b._master;
        }
    }
  };
  ...
  b.setVolume = function (a, c, d) {
    ...
    if (c == null)
      for (f in b.soundHash) {
        e = b.soundHash[f];
        c = e.length;
        for (d = 0; d < c; d++) (e[d].storedVolume = a), (e[d].volume = a);
      }
    else {
      e = b.soundHash[c];
  ...
  b.setMute = function (a, c, d) {
    ...
    if (c == null)
      for (f in b.soundHash) {
        e = b.soundHash[f];
        c = e.length;
        for (d = 0; d < c; d++) e[d].muted = a;
      }
    else {
      e = b.soundHash[c];
      if (e == null) return false;
      c = e.length;
      if (d == null) for (d = 0; d < c; d++) e[d].muted = a;
      else {
        if (c <= d) return false;
        e[d].muted = a;
      }
  ...
  b.pause = function (a, c) {
    ...
    if (a == null)
      for (g in b.soundHash) {
        f = b.soundHash[g];
        e = f.length;
        for (d = 0; d < e; d++) f[d].pause();
      }
    else {
      f = b.soundHash[a];
      if (f == null) return false;
      e = f.length;
      if (c == null) for (d = 0; d < e; d++) f[d].pause();
      else {
        if (e <= c) return false;
        f[c].pause();
      }
  ...
  b.resume = function (a, c) {
    ...
    if (a == null)
      for (g in b.soundHash) {
        ...
        for (d = 0; d < e; d++)
          (f = b.soundHash[g][d]),
            (f.loop || (f.currentTime != f.duration && f.currentTime != 0)) &&
              f.play();
      }
    else {
      if (b.soundHash[a] == null) return false;
  ...
  b.stop = function (a, c) {
    ...
    if (a == null)
      ...
      if (c == null)
        for (d = 0; d < e; d++)
          (f = b.soundHash[a][d]), (f.currentTime = 0), f.pause();
      else {
        if (e <= c) return false;
        f = b.soundHash[a][c];
        f.currentTime = 0;
      ...
      for (d in b.soundHash) {
        if (
          ((c =
            ...
            b.soundHash[d] &&
            b.soundHash[d][0] &&
            b.soundHash[d][0].loaded),
          !c)
        )
          break;
      }
    else return b.soundHash[a] && b.soundHash[a][0] && b.soundHash[a][0].loaded;
    return c;
  };
  ...
  b.getCurrentLoadProgress = function () {
    return (
      (b.itemsToLoad - b.loadQueue.length - (1 - b._currentLoad)) /
      b.itemsToLoad
    );
  };
  b.getInstance = function (a, c) {
    return a == null || c < 0 || !b.soundHash[a] || !b.soundHash[a][c]
      ? null
      : b.soundHash[a][c];
  };
  b.beginPlaying = function (a, c, d, e) {
    ...
    if (!j[0].loaded)
      throw Error(
        "Audio is not loaded. The source(s) are either not found, or the correct audio formats are not provided."
      );
    for (var k = j.length, a = 0; a < k; a++) {
      ...
      g == null &&
        ...
        ((g = h), (f = a));
      if (
        (h.currentTime >= h.duration - b.FT && !h.loop) ||
        (h.currentTime == 0 && h.paused)
      )
        (i = true), (k = a);
      else if (
        (c == b.INTERRUPT_EARLY && h.currentTime < g.currentTime) ||
        (c == b.INTERRUPT_LATE && h.currentTime > g.currentTime)
      )
        i = true;
      i && ((g = h), (f = a));
    }
    c == b.INTERRUPT_ANY && !g && ((g = j[0]), (f = 0));
    return g
      ? ((g.loop = e),
        (g.storedVolume = d),
  ...
  b.loadNext = function () {
    if (b.loadQueue.length <= 0) {
      if (b.onLoadQueueComplete) b.onLoadQueueComplete();
    } else {
      var a = b.loadQueue.shift(),
        ...
        a = a.src,
        e = b.soundHash[d];
      if (e == null) e = b.soundHash[d] = [];
      else if (e.length) a = e[0].src;
  ...
  b.handleProgress = function () {
    ...
    if (b.onProgress) b.onProgress(b.getCurrentLoadProgress());
  };
  ...
  b.handleAudioComplete = function () {
    ...
    clearTimeout(this.timeoutId);
    this.loaded = true;
    if (b.onSoundLoadComplete) b.onSoundLoadComplete(this, a[0], a[1]);
    b.loadNext();
  };
  ...
  b.testAudioStall = function () {
    ...
    if (!b.soundHash[a[0]][a[1]].loaded) {
      if (b.onStall) b.onStall(this, a[0], a[1]);
      b.loadNext();
    }
  };
  a.SoundJS = b;
